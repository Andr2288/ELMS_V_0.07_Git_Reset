                ...
                <div className="p-6 border-b border-gray-200 bg-white rounded-t-2xl flex-shrink-0">
                    <div className="flex justify-between items-center">
                        ...
                        <button
                            ...
                            disabled={isLoading}
                            className="text-gray-400 hover:text-gray-600 p-2 transition-colors disabled:cursor-not-allowed"
                            title="Закрити (Esc)"
                        >
                            <X className="w-6 h-6" />
                        </button>
                    ...
                    <div className="p-6 space-y-6">
                        ...
                        <div className="text-center">
                            <div className="relative inline-block">
                                <div className="w-24 h-24 rounded-full bg-gray-100 overflow-hidden mx-auto">
                                    {formData.profilePic ? (
                                        <img
                                ...
                                {/* Upload Button */}
                                <label className="absolute -bottom-1 -right-1 w-8 h-8 bg-blue-600 hover:bg-blue-700 rounded-full flex items-center justify-center cursor-pointer transition-colors shadow-lg">
                        ...
                        <div className="bg-gray-50 border border-gray-200 rounded-lg p-3">
                            <p className="text-xs font-medium text-gray-700 mb-2">Швидкі клавіші:</p>
                ...
                <div className="p-6 border-t border-gray-200 bg-gray-50 rounded-b-2xl flex-shrink-0">
                    <div className="flex space-x-3">
                        <button
                            ...
                            className="flex-1 bg-blue-600 hover:bg-blue-700 disabled:bg-blue-400 text-white py-3 px-6 rounded-lg font-medium transition-colors flex items-center justify-center space-x-2 disabled:cursor-not-allowed"
